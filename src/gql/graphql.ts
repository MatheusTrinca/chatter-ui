...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null } };
...
export type CreateMessageMutation = { __typename?: 'Mutation', createMessage: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } };
...
export type GetChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null } };

export type ChatsQueryVariables = Exact<{ [key: string]: never; }>;


export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null }> };
...
export type GetMessagesQuery = { __typename?: 'Query', messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } }> };
...
export type MessageCreatedSubscription = { __typename?: 'Subscription', messageCreated: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } };

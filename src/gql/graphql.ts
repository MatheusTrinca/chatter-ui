...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, name: string, userId: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } | null };
...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, name: string, userId: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } | null } };
...
export type GetChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, name: string, userId: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } | null } };
...
export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name: string, userId: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } | null }> };
